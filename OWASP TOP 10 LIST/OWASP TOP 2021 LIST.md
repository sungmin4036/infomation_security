...
[8. INSECURE DESERIALIZATION (안전하지 않은 역직렬화)](#8.insecure-deserialization(안전하지-않은-역직렬화))

[9. USING COMPONENTS WITH KNOWN VULNERABILITIES (알려진 취약점이 있는 구성요소 사용)](#9.using-components-with-known-vulnerabilities(알려진-취약점이-있는-구성요소-사용))
